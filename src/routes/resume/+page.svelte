...
<svelte:head>
  <title>Resume | Mark Jones</title>
  <meta name="description" content="My up-to-date resume, hire me, a quality programmer!" />
</svelte:head>
...
<section class="container mj-container">
  <h1 class="text-center pt-6">
    ...
    <div class="text-center tracking-widest  text-4xl">Mark Jones</div>
  </h1>

  <div class="text-center font-display text-xl my-3">

mark@taocode.com

[336.608.9475](tel:+1-336-608-9475)
...
- Over 2 decades of direct experience developing websites including:<br>
...
- Maintained and enhanced www.salem.edu and www.salemacademy.com
...
- Created a multiple document interface in Java Swing that gave advanced, secure and flexible access to the remote repository. Menu items, editing tabs and available actions were automatically registered to object types for ÒsmartÓ editing of objects.

### HomeStore.com, Inc
#### Integration Specialist contractor (2/01 -8/01)

- Applications technical lead for integration of rent.net and springstreet.com apartment and rentals listings.
...
- Skills/languages used: UML, SQL Server, ASP, VB/COM, VSS, PERL, ColdFusion, and accounting systems (Solomon) integration.
...
- ColdFusion developer for various projects including technical lead for smalloffice.com, a then client company of Omnikron.
- Designed the Oracle Database backend and implemented the DHTML throughout the site (smalloffice.com)
- As technical lead on the project I was heavily involved in the over-all design of the site including our efforts to integrate with all the smalloffice.com partners. Integration involved sharing of the user database through XML and an exit-page system that would establish the user's session on the partner's web application.
- Technical documentation and workflow diagrams as well as regular meetings were used to help the team of 9 developers produce a cohesive production.
...
- Webmaster of press.grammy.com, the Recording Academy's press/media portal.
- CGI programmer &amp; Technical Contact for www.grammy.com, including maintenance of existing code and creation of new CGI scripts (PERL).
- Modified legacy code to exchange data with IBM for GRAMMY webcast (www.grammy.com).
- Analyze web site traffic logs to generate comprehensive reports of www.grammy.com and press.grammy.com.
...
<div class="text-sm mt-12 mb-4 text-gray italic">Last updated: 2021-11-18</div>
